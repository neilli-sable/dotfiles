...
;;
;;   (setq jaspace-alternate-jaspace-string "Å†")  ; or any other string
;;
...
(defun jaspace-font-lock-keywords ()
  ...
  (let ((keywords '(("Å@" (0 'jaspace-highlight-jaspace-face prepend)))))
